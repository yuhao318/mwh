...
#     return ResNet(PreActBottleneck, [18, 18, 18], [16, 32, 64], num_classes)


def WideResNet_28_10(num_classes=100):
    return ResNet(PreActBlock, [4, 4, 4], [160, 320, 640], num_classes)
